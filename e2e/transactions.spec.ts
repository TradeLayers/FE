...
test.describe('Transaction history', () => {
    ...
    test.fixme('table supports sorting by column', async ({ page, authedPage, mockApi }) => {
        ...
        await mockApi.seed('transactions', [
            { id: 'a', type: 'BUY', symbol: 'AAPL', quantity: 1, price: 200, total: 200, createdAt: '2026-01-01T00:00:00Z' },
            { id: 'b', type: 'BUY', symbol: 'MSFT', quantity: 1, price: 100, total: 100, createdAt: '2026-02-01T00:00:00Z' },
        ]);
        await authedPage;
        await page.getByTestId('nav-account').click();
        await page.getByRole('tab', { name: /Transaction History/i }).click();
